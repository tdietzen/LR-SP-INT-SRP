...
%  [y] = fast_conv(x, h) convolves x and h, and normalizes the output
%         to +-1.
%
%      x = input vector
%      h = input vector
...
Y=X.*H;                         %
y=ifft(Y, Ly2, 'symmetric');    % Inverse fast Fourier transform
y=y(1:1:Ly);                    % Take just the first Ly elements
